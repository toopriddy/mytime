...
{
    NSLog(@"%s respondsToSelector: %s self=%p", __FILE__, selector, self);
    return [super respondsToSelector:selector];
}

- (NSMethodSignature*)methodSignatureForSelector:(SEL)selector
{
    NSLog(@"%s methodSignatureForSelector: %s self=%p", __FILE__, selector, self);
    return [super methodSignatureForSelector:selector];
}

- (void)forwardInvocation:(NSInvocation*)invocation
{
    NSLog(@"%s forwardInvocation: %s self=%p", __FILE__, [invocation selector], self);
